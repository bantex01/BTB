		...
		for line in f:
			if "HomeTeam" in line:
				...
				if split_array[0] in DIV_DICT:
					...
					file_to_write_to = "/opt/splunk/etc/apps/search/lookups/fixtures_" +str(split_array[0]) +".csv"	
